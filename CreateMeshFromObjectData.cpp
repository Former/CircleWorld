...
namespace
{
	class DrawOp : public ThreadPool::AsyncOpForPool
	{
	public:
		DrawOp(OUT const DrawObjectPtr& a_DrawObject, const F3DCircleNodePtr& a_Object, const IDrawStrategyPtr& a_Strategy, const IPriorityCalculatorPtr& a_PriorityCalculator, const ThreadPool::ThreadPoolPtr& a_ThreadPool)
		: ThreadPool::AsyncOpForPool(a_ThreadPool)
		{
			m_DrawObject = a_DrawObject;
			m_Object = a_Object;
			m_Strategy = a_Strategy;
			m_PriorityCalculator = a_PriorityCalculator;
		}

		virtual double GetPriority() const override
		{
			return m_PriorityCalculator->GetPriority();
		}
	...
	private:
		DrawObjectPtr m_DrawObject;
		F3DCircleNodePtr m_Object;
		IDrawStrategyPtr m_Strategy;
